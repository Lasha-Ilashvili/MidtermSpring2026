...
public class Main {
    ...
    private static class SelfTest {
        ...
        private final InnerModel model = new InnerModel();
        private final InnerView view = new InnerView();
        private final InnerController controller = new InnerController(model, view);
